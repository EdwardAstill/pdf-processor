...
fn table_candidates_to_blocks(page_num: usize, candidates: Vec<TableCandidate>) -> Vec<Block> {
    candidates
        .into_iter()
        .enumerate()
        .map(|(idx, candidate)| Block { override_markdown: None, id: 2_000_000 + idx,
    ...
    candidates
        ...
        .filter_map(|(idx, candidate)| {
            if is_unresolved_formula_review(&candidate) {
                return Some(Block { override_markdown: None, id: 3_100_000 + idx,
                bbox: candidate.bbox,
                text: String::new(),
            ...
            Some(Block { override_markdown: None, id: 3_000_000 + idx,
            bbox: candidate.bbox,
...
fn save_page_images(image_refs: &[ImageRef], images_dir: &Path) -> anyhow::Result<Vec<Block>> {
    ...
    for img_ref in image_refs {
        ...
        blocks.push(Block { override_markdown: None, id: 1_000_000 + img_ref.image_index,
        bbox: img_ref.bbox,
        text: String::new(),
