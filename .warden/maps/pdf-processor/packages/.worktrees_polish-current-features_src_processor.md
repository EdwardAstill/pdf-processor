# Package: .worktrees/polish-current-features/src/processor


## `.worktrees/polish-current-features/src/processor/doctor.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/processor/doctor.rs:<module>`
- `DoctorReport` (type) — `doctor::DoctorReport`
- `PdfpStatus` (type) — `doctor::PdfpStatus`
- `run` (function) — `doctor::run`

## `.worktrees/polish-current-features/src/processor/impose.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/processor/impose.rs:<module>`
...
## `.worktrees/polish-current-features/src/processor/inspect.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/processor/inspect.rs:<module>`
...
## `.worktrees/polish-current-features/src/processor/mod.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/processor/mod.rs:<module>`

## `.worktrees/polish-current-features/src/processor/ocr_cmd.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/processor/ocr_cmd.rs:<module>`
- `run` (function) — `ocr_cmd::run`

## `.worktrees/polish-current-features/src/processor/page_range.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/processor/page_range.rs:<module>`
...
## `.worktrees/polish-current-features/src/processor/pages.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/processor/pages.rs:<module>`
...
## `.worktrees/polish-current-features/src/processor/resize.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/processor/resize.rs:<module>`
...
## `.worktrees/polish-current-features/src/processor/search.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/processor/search.rs:<module>`
