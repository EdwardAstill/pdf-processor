# Package: .worktrees/polish-current-features/src


## `.worktrees/polish-current-features/src/batch.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/batch.rs:<module>`
...
## `.worktrees/polish-current-features/src/cli.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/cli.rs:<module>`
...
## `.worktrees/polish-current-features/src/commands.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/commands.rs:<module>`
- `process_one` (function) — `commands::process_one`
- `run` (function) — `commands::run`
- `run_convert` (function) — `commands::run_convert`

## `.worktrees/polish-current-features/src/error.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/error.rs:<module>`
- `VtvError` (type) — `error::VtvError`

## `.worktrees/polish-current-features/src/main.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/main.rs:<module>`
- `main` (function) — `main::main`

## `.worktrees/polish-current-features/src/pipeline.rs`

- `<module>` (module) — `.worktrees/polish-current-features/src/pipeline.rs:<module>`
